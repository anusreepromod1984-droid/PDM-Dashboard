...
/**
 * Deliberately a separate file from the tenant login page, not a shared component —
 * the two forms call different providers and will diverge over time (e.g. future
 * staff MFA).
 */
export default function GbotzLoginPage() {
  const { login } = useGbotzAuth();
    ...
    <div className="flex h-full items-center justify-center bg-surface-2 p-4">
      ...
      >
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          />
          <div>
            <h1 className="text-lg font-semibold text-primary">Gbotz Operations</h1>
